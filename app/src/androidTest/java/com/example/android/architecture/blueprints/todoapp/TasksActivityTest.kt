...
class TasksActivityTest {
    ...
    // And idling resource that waits for Data Binding to have no pending bindings
    ...
    /**
     * Unregister you Idling Resource so it can be garbage collected and not leak any memory.
     */
    @After
